...
# DATABASE
db_host = os.environ.get('db_host', "127.0.0.1")   # An IP or hostname of your PostgreSQL server
#db_port = 5432
db_database = os.environ.get('db_database', "openipam")
db_username = os.environ.get('db_username', "openipam")
